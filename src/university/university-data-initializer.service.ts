...
@Injectable()
export class UniversityDataInitializerService implements OnModuleInit {
  constructor(
    @Inject(UNIVERSITY_MODEL) private universityModel: Model<University>,
  ...
  async onModuleInit(): Promise<void> {
    ...
    const universityData = await lastValueFrom(
    ...
    await Promise.all([this.universityModel.create(universityArr)])
      .then
